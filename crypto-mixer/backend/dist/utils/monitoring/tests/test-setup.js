...
exports.TestUtils = {
     ...
     */
    createMockNotificationChannel(type, overrides = {}) {
        const baseConfigs = {
            webhook: {
                type: 'webhook',
                enabled: true,
     ...
     */
    mockFetchSuccess(responseData = { ok: true, status: 200 }) {
    ...
    mockFetchError(error = new Error('Network error')) {
        const mockFetch = vitest_1.vi.fn().mockRejectedValue(error);
        vitest_1.vi.doMock('node-fetch', () => ({
            default: mockFetch
        }));
        return mockFetch;
     ...
     */
    createTestMonitoringConfig(overrides = {}) {
        return {
            enabled: true,
