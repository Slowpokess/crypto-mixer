...
const up = async (queryInterface, Sequelize) => {
    ...
    await queryInterface.createTable('key_audit_logs', {
        ...
        operation: {
            type: sequelize_1.DataTypes.ENUM('generate', 'access', 'rotate', 'delete', 'sign'),
            allowNull: false,
        ...
        status: {
            type: sequelize_1.DataTypes.ENUM('success', 'failure', 'pending'),
            allowNull: false,
...
exports.down = down;
//# sourceMappingURL=20250606000004-vault-integration.js.map