...
exports.OptimizedQueryBuilder = void 0;
...
class OptimizedQueryBuilder {
    constructor(sequelize, performanceMonitor) {
    ...
    async executeQuery(query, replacements = {}, options = {}) {
        ...
        if (options.cache) {
            ...
            if (cached) {
                logger_1.enhancedDbLogger.debug('🎯 Cache hit для запроса', { queryKey });
                return cached;
            }
        }
        try {
            ...
            if (options.explain && process.env.NODE_ENV === 'development') {
                try {
                    ...
                    logger_1.enhancedDbLogger.debug('📊 EXPLAIN результат', { query: query.substring(0, 100), explain: explainResult });
                }
                catch (explainError) {
            ...
            if (options.cache && result) {
                ...
                logger_1.enhancedDbLogger.debug('💾 Результат сохранен в кэш', { queryKey, ttl: options.cacheTTL });
            }
    ...
    invalidateCache(pattern) {
        ...
        logger_1.enhancedDbLogger.info('🗑️ Инвалидация кэша', { pattern });
    }
    /**
     * Очистка всего кэша
     */
    clearCache() {
        this.cache.clear();
        logger_1.enhancedDbLogger.info('🗑️ Полная очистка кэша');
    }
    /**
...
exports.default = OptimizedQueryBuilder;
//# sourceMappingURL=OptimizedQueryBuilder.js.map